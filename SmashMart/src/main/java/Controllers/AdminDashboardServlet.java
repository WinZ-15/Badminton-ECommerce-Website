...
public class AdminDashboardServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Product> products = pdao.getAllProducts(); // ✅ FIXED
            ArrayList<User> users = udao.getAllUsers();           // ✅ THIS WAS MISSING
            ...
            request.setAttribute("recentOrders", adao.getRecentOrders());

            // ✅ SET ATTRIBUTES
            request.setAttribute("categories", categories);
            request.setAttribute("products", products);
            request.setAttribute("users", users); // ✅ FIX
